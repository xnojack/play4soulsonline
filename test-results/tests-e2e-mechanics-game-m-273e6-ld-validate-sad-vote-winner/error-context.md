...
- Name: tests/e2e/mechanics/game-mechanics.spec.ts >> Mechanics Tests >> Sad Vote >> should validate sad vote winner
- Location: tests/e2e/mechanics/game-mechanics.spec.ts:188:9
