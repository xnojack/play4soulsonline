...
- Name: tests/e2e/cards/loot-monster-room.spec.ts >> Monster Card Tests >> should test Death (boss with soul)
- Location: tests/e2e/cards/loot-monster-room.spec.ts:227:7
