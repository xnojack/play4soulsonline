...
- Name: tests/e2e/mechanics/game-mechanics.spec.ts >> Mechanics Tests >> Eden Pick >> should handle Eden character starting item pick
- Location: tests/e2e/mechanics/game-mechanics.spec.ts:100:9
