...
- Name: tests/e2e/mechanics/game-mechanics.spec.ts >> Mechanics Tests >> Item Activation >> should test item tap ability (tap)
- Location: tests/e2e/mechanics/game-mechanics.spec.ts:289:9
