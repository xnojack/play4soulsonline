...
- Name: tests/e2e/cards/loot-monster-room.spec.ts >> Monster Card Tests >> should attack Rotting Beggar (regular monster)
- Location: tests/e2e/cards/loot-monster-room.spec.ts:154:7
