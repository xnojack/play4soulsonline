...
- Name: tests/e2e/mechanics/game-mechanics.spec.ts >> Mechanics Tests >> Deck Management >> should test item purchase
- Location: tests/e2e/mechanics/game-mechanics.spec.ts:244:9
