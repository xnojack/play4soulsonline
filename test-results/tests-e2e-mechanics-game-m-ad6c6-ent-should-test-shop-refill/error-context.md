...
- Name: tests/e2e/mechanics/game-mechanics.spec.ts >> Mechanics Tests >> Deck Management >> should test shop refill
- Location: tests/e2e/mechanics/game-mechanics.spec.ts:260:9
