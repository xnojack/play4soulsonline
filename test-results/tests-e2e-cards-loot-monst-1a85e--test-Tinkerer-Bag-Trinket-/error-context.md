...
- Name: tests/e2e/cards/loot-monster-room.spec.ts >> Loot Card Tests >> Trinkets >> should test Tinkerer Bag (Trinket)
- Location: tests/e2e/cards/loot-monster-room.spec.ts:23:9
