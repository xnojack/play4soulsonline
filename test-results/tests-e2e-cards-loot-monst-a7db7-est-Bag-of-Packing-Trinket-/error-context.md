...
- Name: tests/e2e/cards/loot-monster-room.spec.ts >> Loot Card Tests >> Trinkets >> should test Bag of Packing (Trinket)
- Location: tests/e2e/cards/loot-monster-room.spec.ts:42:9
