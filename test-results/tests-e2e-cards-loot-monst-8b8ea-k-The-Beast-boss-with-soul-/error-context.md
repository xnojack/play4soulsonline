...
- Name: tests/e2e/cards/loot-monster-room.spec.ts >> Monster Card Tests >> should attack The Beast (boss with soul)
- Location: tests/e2e/cards/loot-monster-room.spec.ts:192:7
