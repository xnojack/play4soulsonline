...
const TUTORIAL_STEPS: TutorialStep[] = [
  {
    id: 'hand',
    title: 'Your Hand',
    description: 'These are your loot cards at the bottom. Drag them to the stack to play, or hover a card and press E to play it.',
    targetAttr: 'data-zone="my-hand"',
  },
  {
    id: 'stack',
    title: 'The Stack',
    description: 'Cards and abilities resolve here. Drag hand cards here to play — a "Drop here to play" hint appears when dragging.',
    targetAttr: 'data-zone="the-stack"',
  },
  {
    id: 'decks',
    title: 'Decks',
    description: 'Loot, treasure, monster, and room decks. Drag to draw, or hover + 1-9 to draw N cards, S to shuffle, R to return, D to discard.',
    targetAttr: 'data-zone="decks"',
  },
  {
    id: 'shop',
    title: 'Shop',
    description: 'Buy cards with coins. Drag a shop card to your items or hand to purchase, or hover + E to buy.',
    targetAttr: 'data-zone^="shop-"',
  },
  {
    id: 'monsters',
    title: 'Monsters',
    description: 'Attack monsters to defeat them. Hover + E to declare attack, C to add damage counters, Shift+C to remove.',
    targetAttr: 'data-zone^="monster-"',
  },
  {
    id: 'items',
    title: 'Your Items',
    description: 'Your character card and equipped items at the bottom. Hover + E to tap/activate, C to add counters, Shift+C to remove.',
    targetAttr: 'data-zone="my-items"',
  },
  {
    id: 'other-players',
    title: 'Other Players',
    description: 'Other players are shown at the top of the board. Hover any player to see their expanded panel with items, stats, and cards.',
    targetAttr: 'data-zone="other-players"',
  },
  {
    id: 'quick-actions',
    title: 'Quick Actions',
    description: 'Hover a card and press E to interact, C to add/remove counters. Right-click any card or deck for a quick-action menu with clickable buttons.',
    targetAttr: 'data-tutorial="shortcuts"',
  },
];
